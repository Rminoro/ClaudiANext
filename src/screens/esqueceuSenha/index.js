...
import { View, TextInput, StyleSheet, TouchableOpacity, Text, Button, Modal, Alert } from 'react-native'; // Adicionado o Modal e o Alert
...
const EsqueceuSenha = ({ navigation }) => {
  ...
  const handleRecuperarSenha = async () => {
    try {
      ...
      setModalMessage('Erro ao recuperar senha. Verifique seus dados e tente novamente.');
